...
\begin{enumerate}[(a)]
\item Ersetzen des Preises im Artikellisting\\Block: \emph{frontend\_listing\_box\_article\_price\_default}
\item Einfügen der Konfigurationsoberfläche in der Detailseite\\Block: \emph{frontend\_detail\_index\_detail}
\item Einfügen von clientseitiger Logik mittels Einbindung von Javascript-Dateien in der Detailseite\\Block: \emph{frontend\_index\_header\_javascript}
\end{enumerate}
