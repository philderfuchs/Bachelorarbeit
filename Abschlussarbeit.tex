...
Durch einen Klick auf eine Warenkorbposition gelangt der Anwender zur Detailsansicht der Variante. Beim Anlegen der Variante wurde in eine \emph{configurationID} hinterlegt. Über diese wird die \emph{configuration} geladen, wodurch der letzte Stand der Konfigurationsoberfläche wieder hergestellt wird. Abbildung \ref{fig:konzeptCopy} zeigt den Vorgang im Detail. 
