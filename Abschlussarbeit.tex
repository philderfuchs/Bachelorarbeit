...
\begin{minipage}{\linewidth}
	\centering
	\includegraphics[width=0.8\linewidth]{Abbildungen/tactonModellExecution.pdf}
...
\end{enumerate}
\item Die tatsächlichen Optionen werden als \textbf{Fields} bezeichnet. Sie bestehen aus einer Beschreibung und einem Interaktionselement, über das der Anwender eine Entscheidung treffen kann. Eine Entscheidung bedeutet: ein Wert aus dem Wertebereich von Part-Attributen.\\
