...
Gemäß Anforderung TC.NF03 ist bereits klar, dass das TCsite-Plugin einen Webservice darstellen wird, der den Einschränkungen des REST-Architekturstils gerecht werden soll. Dementsprechend müssen die Ressourcen mit deren Repräsentationen und Verknüpfungen (Hypermedia) konzipiert werden. Außerdem muss festgelegt werden, unter welcher URI mit welchen Methoden mit einer Ressource interagiert werden kann.
