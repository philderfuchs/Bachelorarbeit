...
\end{enumerate}
\item Die tatsächlichen Optionen werden als \textbf{Fields} bezeichnet. Sie bestehen aus einer Beschreibung und einem Interaktionselement, über das der Anwender eine Entscheidung treffen kann. Eine Entscheidung bedeutet: ein Wert aus den Wertebereich von Part-Attributen.\\
